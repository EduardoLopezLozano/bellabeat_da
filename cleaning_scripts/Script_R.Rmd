...
graph_1 <- ggplot(percentege_equipment, aes(x = age, y = percentege, fill = purch_fitness_equipment, colour = purch_fitness_equipment)) +
  ...
  labs(x = "Age", y = "Percentege", fill="Purchase?", colour="Purchase?") +
  geom_text(aes(label=percentege), position = position_fill(vjust = 0.5), show.legend = FALSE, color="black") +
  ggtitle("Percentege of Purchase Equipment by Age", subtitle = "Percentege of purchase made by women according age") +
  theme(axis.text.y=element_blank())

#ggsave("percentege_of_purchase_equipment_by_age.png",  width = 6, height = 4.5)
